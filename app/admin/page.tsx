      ...
      <div className="flex flex-col gap-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage users, products, orders, and community content.
          </p>
        </div>
                            ...
                            <div className="grid gap-4 py-4">
                              <div className="flex flex-col gap-2">
                                <Button
                                  ...
                                  onClick={() =>
                                    handleUpdateOrder(order.id, "processing")
                                  }
                                >
                                  Processing
                                </Button>
                                <Button
                                  ...
                                  onClick={() =>
                                    handleUpdateOrder(order.id, "shipped")
                                  }
                                >
                                  Shipped
                                </Button>
          ...
          <TabsContent value="community" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Moderate discussions, reviews, and user content
                </CardDescription>
              </CardHeader>
              <CardContent>
